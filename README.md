...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pre-commit-hooks-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14908&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pre-commit-hooks-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pre-commit-hooks` can be installed with:

```
conda install pre-commit-hooks
```

It is possible to list all of the versions of `pre-commit-hooks` available on your platform with:
